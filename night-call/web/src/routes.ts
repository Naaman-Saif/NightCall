...
export function readRoute(location: Location): Route {
  ...
  if (!match) return { page: 'list', showSample: isSample, isOperator: OPERATOR_PATH.test(location.pathname) };
