...
export const MEMORY_TOP = 22;
export const MEMORY_HEIGHT = 58;
export const CPU_TOP = 108;
export const CPU_HEIGHT = 32;
export const AXIS_TOP = 140;
export const PLOT_HEIGHT = 162;
